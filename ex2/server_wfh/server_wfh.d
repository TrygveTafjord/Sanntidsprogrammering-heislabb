...
__gshared string    localIP2 = "10.100.23.17";
__gshared string    localIP;
__gshared string    serverIP = "10.100.23.129"; 
__gshared Mutex     consoleMtx;

__gshared ushort    udpAnnouncePort = 30000;
__gshared ushort    udpRecvPort     = 20000; 
__gshared ushort    udpSendPort     = 20007;//this was 20001
...
void main(string[] args){
    ...
    //UDPEchoer(localIP2, serverIP, 20000, 20007); 
    UDPAnnouncer(localIP2,serverIP,20007);
...
void UDPAnnouncer(string localIP, string bcastIP, const ushort port){
    ...
    while(1){
        auto r = sendSock.sendTo(cast(ubyte[])format("This is group X. Hello from UDP server at %s!", localIP), bcastAddr);
